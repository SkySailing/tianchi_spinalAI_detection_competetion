...
config['tranform'] = 1
config['saveName'] = 'UNet_double_PosiLoss_100v50_final_model.ckpt'
config['checkout'] = "UNet_double_PosiLoss_100v100_final_model.ckpt"
...
class posiLoss(nn.Module):
    def __init__(self, alph=100, beta=50):
